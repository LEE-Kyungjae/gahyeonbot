...
@Entity
@Table(name = "github_trending_events", indexes = {
        @Index(name = "idx_github_trending_events_snapshot_date", columnList = "snapshot_date"),
        @Index(name = "idx_github_trending_events_sent_at", columnList = "sent_at")
})
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class GitHubTrendingEvent {
